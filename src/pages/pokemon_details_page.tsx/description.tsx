  ...
  return (
    <div className="shadow-x flex flex-col gap-5 rounded-2xl p-10 backdrop-brightness-90 *:text-center md:*:text-start dark:backdrop-brightness-130">
      ...
      <div className="flex flex-col gap-1">
        <h2 className="text-gray-300">Height : {pokemonDetails.height}0 cm</h2>
        <h2 className="text-gray-300">Weight : {finalWeight} kgs</h2>
      </div>
      <div>
        <h1 className="mb-2 text-2xl font-medium">TYPE</h1>
